	...
	<div class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="#">Data Penjualan WIFI JSON Version</a>
			</div>
		</div>
	</div>
...
<a type="button" class="btn btn-success" class="link-blue" href="index.php/kontakxml">XML Version</a> <span>




	<a type="button" class="btn btn-primary" href="http://localhost/rest_ci_client/index.php/kontak/create">Tambah data</a> </span>