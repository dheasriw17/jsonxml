...
<body>
    ...
    <div id="container">
        ...
        <div id="body">
            ...
            <ol>
                <li><a href="<?php echo site_url('api/kontak/data'); ?>">Users</a> - defaulting to JSON</li>
                <li><a href="<?php echo site_url('api/kontak/data/format/csv'); ?>">Users</a> - get it in CSV</li>
                <li><a href="<?php echo site_url('api/kontak/data/id/1'); ?>">User #1</a> - defaulting to JSON (users/id/1)</li>
                <li><a href="<?php echo site_url('api/kontak/data/1'); ?>">User #1</a> - defaulting to JSON (users/1)</li>
                <li><a href="<?php echo site_url('api/kontak/data/id.xml'); ?>">User </a> - get it in XML (users/id/1.xml)</li>
                <li><a href="<?php echo site_url('api/kontak/data/id/format/xml'); ?>">User #1</a> - get it in XML (users/id/1/format/xml)</li>
                <li><a href="<?php echo site_url('api/kontak/data/id/1-10?format=xml'); ?>">User #1</a> - get it in XML (users/id/1?format=xml)</li>
                <li><a href="<?php echo site_url('api/kontak/data/1.xml'); ?>">User #1</a> - get it in XML (users/1.xml)</li>
                <li><a id="ajax" href="<?php echo site_url('api/kontak/data/format/json'); ?>">Users</a> - get it in JSON (AJAX request)</li>
                <li><a href="<?php echo site_url('api/kontak/data.html'); ?>">Users</a> - get it in HTML (users.html)</li>
                <li><a href="<?php echo site_url('api/kontak/data/format/html'); ?>">Users</a> - get it in HTML (users/format/html)</li>
                <li><a href="<?php echo site_url('api/kontak/data?format=html'); ?>">Users</a> - get it in HTML (users?format=html)</li>
            </ol>
